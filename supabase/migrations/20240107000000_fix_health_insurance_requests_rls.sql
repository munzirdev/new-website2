...
-- This migration ensures that both authenticated users and guests can submit health insurance requests
...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'RLS policies for health_insurance_requests table have been updated successfully';
    ELSE
        RAISE NOTICE 'health_insurance_requests table does not exist';
    END IF;
END $$;
